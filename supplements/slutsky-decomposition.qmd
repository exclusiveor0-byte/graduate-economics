...
상호작용을 사용할 수 없는 환경을 위한 기본 설정의 그림이다. 보상 규칙을
Slutsky로 두면 청록 예산선은 초기 묶음을 지난다. Hicks로 바꾸면 청록점이
초기 무차별곡선 위에 놓이도록 이동한다.

![초기 예산선, 가격 변화 뒤 예산선, 보상 예산선과 세 수요점을 보이는 Slutsky 분해의 정적 그림](../assets/images/slutsky-decomposition-static.svg){.supplement-fallback fig-alt="Slutsky 분해의 정적 예산선 그림"}
